      ...
      >
        ...
        >
          ...
          <div className="absolute top-4 right-4 flex items-center gap-2">
            <button
              onClick={toggleSound}
              className="p-2 rounded-lg bg-surface-800/60 text-surface-400 hover:text-white transition-colors"
              id="emergency-sound-toggle"
            >
          ...
          <div className="flex justify-center mb-6">
            ...
            >
              <AlertTriangle
                size={40}
                className={isCritical ? 'text-danger-400' : 'text-warning-400'}
              />
            </motion.div>
          </div>
          ...
          {/* Title */}
          <h1
            className={`text-center text-2xl font-black mb-2 tracking-wide uppercase ${
