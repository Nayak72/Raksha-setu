 ...
 * Generates mock agent log entries from alerts + detections data.
 */
...
const agentColors = {
  detection: 'text-danger-400',
  weather: 'text-warning-400',
  dispatch: 'text-safe-400',
  system: 'text-raksha-400',
};

const agentBgColors = {
  detection: 'bg-danger-500/10 border-danger-500/20',
  weather: 'bg-warning-500/10 border-warning-500/20',
  dispatch: 'bg-safe-500/10 border-safe-500/20',
  system: 'bg-raksha-500/10 border-raksha-500/20',
};
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span
                        className={`w-1.5 h-1.5 rounded-full ${log.severity === 'critical'
                        ...
                        >
                          <div className="mt-3 space-y-2">
                            <div className="bg-surface-900/40 rounded-lg p-2.5">
                              <div className="text-[10px] uppercase tracking-wider text-surface-500 mb-1 font-semibold">
                                Reasoning
                              </div>
