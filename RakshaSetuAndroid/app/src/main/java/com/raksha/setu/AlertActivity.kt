...
class AlertActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        startAlarmSound()
        startVibration()
        showAlertNotification(zone, severity, message)
    ...
    /**
     * Show a high-priority notification for the alert.
     */
    private fun showAlertNotification(zone: String, severity: String, message: String) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
